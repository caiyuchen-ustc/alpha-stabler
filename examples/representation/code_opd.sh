...
# ============================================================================
# Code On-Policy Distillation (OPD), distillation.
#
...
EXP_NAME_PREFIX="${EXP_NAME_PREFIX:-code_opd}"
...
TRAIN_FILE=${TRAIN_FILE:-"${LEGACY_DATA_ROOT}/training_data/Eurus/code_train.parquet"}
...
DEFAULT_LOCAL_DIR_BASE=${DEFAULT_LOCAL_DIR_BASE:-"${PROJECT_ROOT}/outputs/code_opd"}
DEFAULT_LOCAL_DIR=${DEFAULT_LOCAL_DIR:-"${DEFAULT_LOCAL_DIR_BASE}/${TRAIN_TAG}_lr${ACTOR_LR}"}
SAVE_VECTOR_BASE_DIR=${SAVE_VECTOR_BASE_DIR:-"${PROJECT_ROOT}/outputs/code_opd/vectors"}
SAVE_VECTOR_DIR=${SAVE_VECTOR_DIR:-"${SAVE_VECTOR_BASE_DIR}/${TRAIN_TAG}_lr${ACTOR_LR}"}

EXPERIMENT_NAME="${EXPERIMENT_NAME:-code_opd}"
