...
EXP_NAME_PREFIX="${EXP_NAME_PREFIX:-4b_distill_offline}"
...
OFFLINE_TEACHER_DATA_PATH=${OFFLINE_TEACHER_DATA_PATH:-"${PROJECT_ROOT}/data/math/teacher_responses.parquet"}
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-4b_distill_offline}"
LOCAL_DIR_BASE=${LOCAL_DIR_BASE:-"${PROJECT_ROOT}/outputs/4b_distill_offline"}
