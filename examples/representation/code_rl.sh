...
EXP_NAME_PREFIX="${EXP_NAME_PREFIX:-code_rl}"
...
DEFAULT_LOCAL_DIR_BASE=${DEFAULT_LOCAL_DIR_BASE:-"${PROJECT_ROOT}/outputs/code_rl"}
...
SAVE_VECTOR_BASE_DIR=${SAVE_VECTOR_BASE_DIR:-"${PROJECT_ROOT}/outputs/code_rl/vectors"}
SAVE_VECTOR_DIR=${SAVE_VECTOR_DIR:-"${SAVE_VECTOR_BASE_DIR}/${TRAIN_TAG}_lr${ACTOR_LR}"}

EXPERIMENT_NAME="${EXPERIMENT_NAME:-code_rl}"
