...
EXP_NAME_PREFIX="${EXP_NAME_PREFIX:-deepseek1p5b_distill_offline}"
...
TEACHER_MODEL_PATH=${TEACHER_MODEL_PATH:-"${PROJECT_ROOT}/models/science-teacher"}
...
OFFLINE_TEACHER_DATA_PATH=${OFFLINE_TEACHER_DATA_PATH:-"${PROJECT_ROOT}/data/science/teacher_responses.parquet"}
...
DATA_ROOT=${DATA_ROOT:-"${LEGACY_DATA_ROOT}/sciknoweval"}
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-deepseek1p5b_distill_offline}"
LOCAL_DIR_BASE=${LOCAL_DIR_BASE:-"${PROJECT_ROOT}/outputs/deepseek1p5b_distill_offline"}
