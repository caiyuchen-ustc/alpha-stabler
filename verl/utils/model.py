...
try:
    from transformers import AutoModelForImageTextToText as AutoModelForConditionalGenerationCompat
except ImportError:
    from transformers import AutoModelForVision2Seq as AutoModelForConditionalGenerationCompat
...
def load_valuehead_model(local_path, torch_dtype, model_config, trust_remote_code):
    ...
    if type(model_config) in AutoModelForConditionalGenerationCompat._model_mapping.keys():
        module_class = AutoModelForConditionalGenerationCompat
    else:
...
_architecture_to_auto_class = {
    ...
    "ForVision2Seq": AutoModelForConditionalGenerationCompat,
    "ForConditionalGeneration": AutoModelForConditionalGenerationCompat,
    ...
    if has_remote_code:
        ...
        match auto_class:
            case "AutoModelForVision2Seq" | "AutoModelForImageTextToText":
                actor_module_class = AutoModelForConditionalGenerationCompat
