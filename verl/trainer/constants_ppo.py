...
def get_ppo_ray_runtime_env():
    ...
    # Forward activation principal-subspace projection ablation vars to Ray workers,
    # so TrainableTokenVectorHook can read them inside the worker process.
    for key in ("PC_PROJECTION_MODE", "PC_PROJECTION_FILE"):
